...
public class Application {
	...
	public void signUp() throws SQLException {
		...
		if(mc.signUp(m)) {
			...
			// false 출력 
			System.out.println("중복된 아이디입니다. 다시 입력해주새요.");
		}
	...
	public void login() throws SQLException {
		...
		memberMenu();
			...
			System.out.println("틀린 아이디 또는 비밀번호입니다. 다시 입력해주세여");
		}
	...
	public void changePassword() throws SQLException {
		...
		if(mc.changePassword(id, password, newPassword)) {
			...
			System.out.println("비밀번호 변경에 실패하셨습니다. 다시 입력해주세요");
		}
	...
	public void changeName() throws SQLException {
		...
		}else { // 이름이 null이면 "이름 변경에 실패했습니다. 다시 입력해주세요." 출력 
