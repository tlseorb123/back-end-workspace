...
public class D_Scanner {
	 ...
	 *                  sc.nextline() - 공백 포함 엔터 전까지 --> 애만 사용하는 것을 권장
	 *     - 정수일 때 : sc.nextInt();
	...
	public static void main(String[] args) {
	 ...
	 System.out.println("당신의 집은 어디씹니까? > ");
	 ...
	 double height = sc.nextDouble(); // enter
	 sc.nextLine(); // enter  
	 ...
	 System.out.println("당신의 이름은 " + name 
			                                ...
			                                + "cm, 성별은 " + gender + "입니다.");
	 // --> printf 변경!
	 System.out.printf("당신의 이름은 %s 이고 사는 곳은 %s, 나이는 %d살, 키는 %.1fcm. 성별은 %c 입니다.",
