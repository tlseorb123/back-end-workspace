...
public void method1() {
	     ...
	     int b = 25;
			...
			//             나머지가 1인 경우 == 2로 나뉘어떨어지지 않음 == 홀수
			System.out.println("a가 짝수인가? : " + (a % 2 == 0)); // true
			System.out.println("b가 짝수인가? : " + (b % 2 != 0)); // true
			System.out.println("a가 짝수인가? : " + !(a % 2 == 0)); // false
			System.out.println("a가 짝수인가? : " + (a % 2 == 1)); // false
...
public void method2() {
	...
	System.out.print("첫번째 정수 입력 > "); // 20
	int num1 = sc.nextInt();
	
	System.out.print("두번째 정수 입력 > "); // 98
	int num2 = sc.nextInt();
