...
//		a.method3();
	...
	public void mthod1() {
      ...
      // new 키워드를 쓰면 주소값이 봔환되서 false가 나온다 

       
       // String 이 equals를 제공해주니까 equals는 재정의를 한다 , 명확하다.
    ...
    //	      - 전달 받은 무자열과 원본 문자열을 하나로 합친 새로운 문자열을 생성해서
    ...
    //       - 문자열의 beginIndex 위피에서부터 endindex-1까지 
    ...
    //    - 전달받은  str의 시작 인텍스를 리턴 (포함되어 있지 않으면 -1 )
       int index = str.indexOf("!");
    	System.out.println("index : " + index); // 11
    	
    	int index2 = str.indexOf("Jaba");
	 ...
	 * - 16개의 문자를 저장할 수있는 버퍼가 미리 생성되고 문자가 저장됨에 따라 자동 증가
	...
	public void method3() {
	    ...
	    //     - 문자열 offset 위치부터 전달받은 문자열 추가
		sb.insert(1, "eeee");
		
//		System.out.println(sb);   	
		
	    // 3. deldete (int start.int end ) : StringBuilder
	    ...
	    // 
	    StringBuilder sb2 = new StringBuilder("Java Progrm");
	    
	    sb2.reverse().delete(0, 6 ).insert(1, "API");
	...
	public void method4() {
		String str = "HTML,CSS,JavaScript,MySQL,Java,JDBC,Servlet,JSP,JQuery,MyBatis";
