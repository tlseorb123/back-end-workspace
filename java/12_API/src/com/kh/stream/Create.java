 ...
 *     - 중간 처리 : 반복, 메핑(타입 변환), 필터링, 정렬 등 
 *     - 최종 처리 : 반복, 카운팅, 평균, 총합 들의 집계 처리 
...
public class Create {
	...
	public void method1() {
		// 첫 번쨰 매개 값 ~ 두 번쨰 매개 값 이전까지의 값을 요소로 가지는 스트림 객체 생성
...
//		System.out.println("sum : " + sum);
		...
		sum = stream.sum();
		System.out.println("rangeClosed 의 sum : " + sum);
	}
	
	/*
	 * 배열(컬랙션)로부터 스크림을 생성하는 방법
	 * 
	 * 
	 * */
	public void method2() {
