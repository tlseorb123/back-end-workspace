 ...
 * 프로토콜 ://호스트명:포드번호/경로명/파일명?쿼리스트링
 * - 프로토콜 : 자원에 접근하기 위해 서버와 통신하는ㄴ데 사용되는 통신규약
...
public class URLTest {
	...
	public void method1() {
		try {
		    ...
		    System.out.println("포로토콜 : " + url.getProtocol());
 ...
 * 4계층 - 에플리케이션 계층     7계층 : 응용 계층 - 프로토콜(HTTP, FTP, SMTP, POP3 ...)
